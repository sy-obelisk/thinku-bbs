...
<div class="span10" id="datacontent">
    ...
    <form action="/user/user/add" method="post" class="form-horizontal">
        <fieldset>
            ...
            <div class="control-group">
                ...
                <div class="controls">
                    <input type="text" value="" name="user[nickname]">
                </div>
            </div>
            <div class="control-group">
                <label for="area" class="control-label">电话：</label>
                <div class="controls">
                    <input value="" type="text" name="user[phone]">
                </div>
            </div>
            <div class="control-group">
                <label for="area" class="control-label">邮箱：</label>
                <div class="controls">
                    <input value="" type="text" name="user[email]">
                </div>
            </div>
            <div class="control-group">
                <label for="area" class="control-label">密码：</label>
                <div class="controls">
                    <input value="" type="text" name="userPass">
                </div>
            </div>
            <div class="control-group">
                <label for="area" class="control-label">头像：</label>
                <div class="controls">
                    <input type="text" value="" class="image" name="user[image]">
