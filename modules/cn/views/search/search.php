        ...
        <ul>
          <?php foreach ($data as $v) { ?>
            <li class="item">
              ...
              <div class="right">
                <h3>
                  <a href="/details/<?php echo $v['id'] ?>.html"><?php $keyword = Yii::$app->request->get('keyword', '');echo (str_replace($keyword,"<span style='color:red;'>".$keyword.'</span>',strip_tags($v['name'])));?></a>
                </h3>
                <div class="info-list clearfix">
                  <div class="first-div"><span><?php echo $v['nickname'] ? $v['nickname'] : $v['userName'] ?></span>
                    <span>发布于<?php echo substr($v['createTime'], 0, 10) ?></span></div>
                  <div class="last-div">
