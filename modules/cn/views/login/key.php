...
<div class="login-wrap">
  <div class="cnt">
    ...
    <div class="login-phone userMessage">
      <div>
        <ul>
          ...
          <li>
            ...
            <div class="rightInput">
              <input class="userPass" type="password" placeholder="新密码" datatype="*6-16" errormsg="密码范围在6~16位之间！" value="" onkeypress="javascript:enterLogin(event);"/>
            </div>
          </li>
        </ul>
      </div>
      ...
      <div class="loginBtn">
        <input onclick="subLogin()" type="button" value="提交" id="btn_sub"/>
      </div>
