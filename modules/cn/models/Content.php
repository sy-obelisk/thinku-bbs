...
class Content extends ActiveRecord
{
    ...
    public function getList($first,$second='',$third='',$pageSize=15,$page=1)
    {
        ...
        $sql = "select c.id,c.name,c.abstract,c.viewCount,u.username,u.nickname,u.image from {{%content}} c LEFT JOIN {{%user}} u ON u.id=c.userId WHERE $where order by c.id DESC,c.sort ASC";
