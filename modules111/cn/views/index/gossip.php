        ...
        <div class="left fl">
            ...
            <div class="bg-f lc-2">
                <ul class="post-list tm clearfix">
                    <li data-mouse="/#H_all" onmouseover="mouseLi(this)">
                        <div class="postNav-1">
                    ...
                    foreach($firstCategory as $v) {
                        ?>
                        <li <?php echo $pid==$v['id']?'class="on"':''?>  data-mouse="/post/<?php echo $v['id'] ?>.html#<?php echo $v['id'] ?>" onmouseover="mouseLi(this)">
                            <div class="postNav-1" id="<?php echo $v['id'] ?>">
                                <img src="<?php echo $v['image']?>" alt="">

                                <a href="/post/list/<?php echo $v['id'] ?>.html#<?php echo $v['id'] ?>"><P><?php echo $v['name']?></P></a>
                            </div>
                            <img class="crow-3" src="/cn/images/crow-3.png" alt="">
                        </li>
                    <?php
                    ...
                    if($pid) {
                        ...
                        <ul class="post-list2  clearfix" style="display: block">
                            ...
                            foreach($secondCategory as $v) {
                                ?>
                                <li <?php echo $catId==$v['id']?'class="on"':''?> id="n<?php echo $v['id']?>">
