...
<head>
    ...
    <title><?php echo $keywords?>-雷哥网社区-我们就爱分享知识！</title>
</head>
<body id="community">
<!--搜索-->
...
<section>
    <div class="w12 location">
        <div class="tzTop2">
        <a href="/">首页</a>&nbsp;>&nbsp;<em><?php echo $data['name']?></em>
        </div>
    </div>
</section>
<!--社区内容-->
        ...
        <div class="left fl">
            <div class="lc-1 bg-f">
                ...
                <div class="lc-tit">
                    ...
                    <span class="lc-tit-word"><?php echo $keywords?></span>
            ...
            <div class="bg-f lc-3">
                ...
                <script type="text/javascript">
                    ...
                    $("body").on("click",".iPage",function(){
                        var page = $(this).html();
                        location.href="/search/<?php echo $keywords?>/"+page+".html";
                    })
                </script>
            </div>
        </div>
