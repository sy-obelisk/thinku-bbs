<div class="row control-tit wrapper border-bottom white-bg">
    <span>推荐课程</span>
    <a class="addRole" href="/hot/recommend/add-hot?id=<?php echo isset($_GET['id'])?$_GET['id']:0 ?>">添加</a>
</div>
...
<div class="over-auto">
        ...
        <table class="table-container">
            ...
            <tr>
                ...
                <td class="tm"><a href="/hot/recommend/update-recommend?id=<?php echo $v['id'] ?>">修改</a>---<a href="/hot/recommend/index?id=<?php echo $v['id'] ?>">查看内容</a>----<a href="/hot/recommend/delete?id=<?php echo $v['id'] ?>">删除</a></td>
                <?php
                }
                } else { ?>
                    <div>还没有模块</div>
